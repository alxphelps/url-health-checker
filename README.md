...
```text
Endpoint    | HTTPS | HTTPS Response Time   | HTTP | HTTP Response Time   | Certificate | TLS
------------+-------+-----------------------+------+----------------------+-------------+-----
...
The `HTTPS|HTTP Response Time` columns show how long each HTTP or HTTPS request took in milliseconds.
